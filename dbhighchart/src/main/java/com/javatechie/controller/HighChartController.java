...
public class HighChartController {
    ...
    public ResponseEntity<Map<String, Integer>> getPieChart1() {
		...
		/*
		 * graphData.put("2016", 147); graphData.put("2017", 1256);
		 * graphData.put("2018", 3856); graphData.put("2019", 19807);
		 */
    	...
    	for (int i = 0; i < listYearPopulation.size(); i++) {
			...
			graphData.put(String.valueOf(listYearPopulation.get(i).getYEAR()), listYearPopulation.get(i).getPOPULATION());
		}
